...
final themeProvider =
    StateNotifierProvider<ThemeSettingsNotifier, ThemeName>((ref) {
  final prefs = ref.watch(sharedPreferencesProvider);
  return ThemeSettingsNotifier(prefs);
});

final colorSchemesProvider = Provider<Map<ThemeMode, ColorScheme>>((ref) {
  final currentTheme = ref.watch(themeProvider);
  final theme = placesThemes[currentTheme]!;
  return {
